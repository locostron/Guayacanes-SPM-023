...
// Copyright (c) 2019, The Guayacanes Developers
//
...
For example:
Guayacanesd --print-genesis-tx --genesis-block-reward-address XL4QZU4Nsxm6JdXWetmGbdchPo8E5TxgJFnWWTrDRaEQ5suw7mXUqVVEiBJtqYCv7BJT7WwRB65xCcX9Y1pZhAMW2X3RPBjCH
...
const char     CRYPTONOTE_NAME[]                             = "Guayacanes";
...
const char     LATEST_VERSION_URL[]                          = "https://github.com/Guaycoin/Guayacanes/releases";
const std::string LICENSE_URL                                = "https://github.com/Guaycoin/Guayacanes/blob/master/LICENSE";
